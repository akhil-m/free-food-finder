...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'free_food_finder_profile')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'free_food_finder_profile', (
        ...
        db.send_create_signal(u'free_food_finder', ['Profile'])
